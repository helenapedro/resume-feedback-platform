...
{
  "summary": "executive assessment in 1 short sentence",
...
- Return exactly 3 strengths and exactly 3 improvements.
...
- Each item must be one concise sentence under 28 words.
